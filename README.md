...
Named after Alfa Romeo's *Twin Spark* engines — two spark plugs per cylinder,
firing together for a cleaner, stronger burn. Here it is two DGX Sparks firing
as one: tensor parallelism over a direct RoCE link, serving a 196.6 GiB model
on a pair of 121.69 GiB boxes.
